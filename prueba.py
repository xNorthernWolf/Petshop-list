...
To adjust the directory where the images are stored, adjust 'image_directory' in the line ~17.
"""
...
gen = 6
url = rf'https://lpsmerch.com/g{gen}/all/'
...
image_directory = rf'C:\Users\xNort\Desktop\Cosas varias\DevOps\Python\Petshop-list\lps_all\gen_{gen}'
